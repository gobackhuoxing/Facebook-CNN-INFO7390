...
tf.flags.DEFINE_string("data_path", "./data/", "Data source .")
...
# Load data
print("Loading data...")
#x_text, y = cnn_model.load_data_and_labels5(FLAGS.data_path)
#if it is too slow, using the following line to load a small data
x_text, y = cnn_model.load_data_and_labels3(FLAGS.data_path)
print("Data Size: {:d}".format(len(x_text)))
...
print("Classes number: {:d}".format(y_shuffled.shape[1]))
